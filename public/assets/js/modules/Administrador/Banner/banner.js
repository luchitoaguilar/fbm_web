...
$(function () {
    var tablaPrincipal = $('#tabla-banner').DataTable({
        ...
        columns: [
            ...
            { data: 'datos', name: 'datos', title: 'Datos banner', orderable: true, searchable: true },
            { data: 'precio', name: 'precio', title: 'Precio banner', orderable: true, searchable: true },
            { data: 'imagen_frente', name: 'imagen_frente', title: 'Imagen frontal', orderable: false, searchable: true },
            { data: 'imagen_fondo', name: 'imagen_fondo', title: 'Imagen fondo', orderable: false, searchable: true },
            { data: 'enlace', name: 'enlace', title: 'enlace', orderable: true, searchable: true },
            {
                title: 'Opciones', searchable: false, orderable: false, data: function (row, type, set) {
                    return `<a onclick="vm.$options.methods.showBanner(${row.id})" class="btn btn-outline-info btn-xs"><i class="fa fa-bars"></i> Detalles</a>`;
                }
            },
        ],
