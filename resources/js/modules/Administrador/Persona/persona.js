$(function () {
    var personaTabla = $('#tabla-persona').DataTable({
        ...
        columns: [
            ...
            { data: 'foto', name: 'personas.foto', title: 'Foto', orderable: false },
            { data: 'paterno', name: 'personas.paterno', title: 'Ap. Paterno', orderable: true, searchable: true },
            { data: 'materno', name: 'personas.materno', title: 'Ap. Materno', orderable: true, searchable: true },
            { data: 'nombres', name: 'personas.nombres', title: 'Nombres', orderable: true, searchable: true },
            { data: 'ci', name: 'personas.ci', title: 'CI', orderable: true, searchable: true },
            { data: 'complemento', name: 'personas.complemento', title: 'Complemento', orderable: true, searchable: true },
            { data: 'telefono', name: 'personas.telefono', title: 'Telefono', orderable: true, searchable: true },
            { data: 'departamento', name: 'nacimiento.departamento', title: 'Lugar Nacimiento', orderable: true, searchable: true },
            { data: 'fecha_nacimiento', name: 'personas.fecha_nacimiento', title: 'Fecha Nacimiento', orderable: true, searchable: true },
