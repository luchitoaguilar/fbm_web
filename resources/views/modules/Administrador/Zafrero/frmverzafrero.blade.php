...
<div class="modal fade" id="frmverzafrero" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title m-0" id="custom-width-modalLabel">Zafrero</h4>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="#" @click.prevent="editZafrero(modelo.id)" class="btn btn-warning"><i
                            class="fa fa-edit"></i> {{ __('messages.botones.editar') }}</a>
                            <template v-if="modelo.activo == true">
                    <a href="#" @click.prevent="deleteZafrero(modelo.id)" class="btn btn-danger"><i
                            class="fa fa-trash"></i> {{ __('messages.botones.eliminar') }}</a>
                            </template>
                            <template v-else>
                                <a href="#" @click.prevent="activateZafrero(modelo.id)" class="btn btn-green"><i
