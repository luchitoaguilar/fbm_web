...
@section('content')
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="form-label col-form-label col-lg-4" for="personal_zafra_id">Personal de
                                        Zafra</label>
                                    <div class="col-lg-8">
                                        <select type="text" class="form-select form-select-lg" name="personal_zafra_id"
                                            id="ex-search" v-model="personal_zafra_id">
                                            <option selected>Seleccione...</option>
                                            <option :value="p.id" v-for="p in personal">@{{ p.nombres }}
                                                @{{ p.paterno }} @{{ p.materno }}
                                            </option>
                                        </select>
                                        <ul class="parsley-errors-list filled" id="parsley-id-19"
                                            v-if="errors.personal_zafra_id">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 pt-2">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" v-model="tipoReporte"
                                                    id="tipoReporte" value="Diario" name="tipoReporte" />
                                                <label class="form-check-label" for="tipoReporte1">Diario</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" v-model="tipoReporte"
                                                    id="tipoReporte" value="Global" name="tipoReporte" />
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    <a href="#" @click.prevent="reporteDiarioZafrero()" class="btn btn-lg btn-primary">
    ...
    @push('variables')
        var auth = {!! Auth::user() !!};
        var imprimir_reporte_diario_zafrero = '{{ route('imprimir_reporte_diario_zafrero') }}';
