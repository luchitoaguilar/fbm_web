<!-- begin modal dialog -->
<div class="modal fade" id="frmpersona" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 v-if="editar" class="modal-title">{{ __('messages.botones.editar') }} {{ __('validation.attributes.persona') }}</h4>
                <h4 v-else class="modal-title">{{ __('messages.botones.agregar') }} {{ __('validation.attributes.persona') }}</h4>
            ...
            <div class="modal-footer">
                <template v-if="editar">
                    <a href="#" @click.prevent="storePersona()" class="btn btn-success"><i class="fa fa-save"></i>
